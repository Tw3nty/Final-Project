...
app.get('/tees', isLoggedIn, ControllerPages.tees)
app.get('/hoodies', isLoggedIn, ControllerPages.hoodies)
app.get('/accessories', isLoggedIn, ControllerPages.accessories)
